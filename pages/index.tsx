...
const HomePage: React.FC = () => {
  ...
  const handlePostsPerPageChange = (event: SelectChangeEvent) => {
    setPostsPerPage(Number(event.target.value)); // Convert string to number
  ...
  return (
    <div style={{ padding: '20px' }}>
      ...
      <Select
        value={postsPerPage.toString()} // Convert to string for compatibility
